...
function ProgramCategoryCard({
  ...
  return (
    <article className="card-interactive group relative flex h-full min-h-[280px] flex-col overflow-hidden p-6 sm:p-7">
      <div
        className="pointer-events-none absolute -right-12 -top-12 h-40 w-40 rounded-full opacity-[0.12] blur-2xl transition-opacity duration-500 [@media(hover:hover)]:group-hover:opacity-[0.2]"
